...
ui <- fluidPage(
    ...
    # Application title
    titlePanel("Calculate DIGEST safety, efficiency, and total scores"),
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            downloadButton("download", "Download DIGEST Scores")
            
        ),
        
        mainPanel(
            p("Upload your data file. It will need the following columns. Please note that column names need to be identical as the template. ", style = "font-family: 'times'; font-si16pt"),
            a("Click here to download a template.", 
              href="https://drive.google.com/file/d/1FDZXmY_gLJPm1m5dJGCSp2E5u_2KAM9G/view?usp=sharing", target="_blank"),  
            # tags$a(href="https://drive.google.com/file/d/1FDZXmY_gLJPm1m5dJGCSp2E5u_2KAM9G/view?usp=sharing", 
            #        "Click here to download a template.", target="_blank"),
            br(),
            br(),
            strong("ID:"),
            em("The participant's ID number."),
            br(),
            strong("IDDSI"),
            em("Bolus consistency according to the"),
            tags$a(href="https://iddsi.org/framework", "IDDSI framework"),
            strong("Note that these are coded numerically."),
            br(),
            strong("Penetration-Aspiration Scale Score:"),
            em("The PAS score for each bolus trial."),
            br(),
            strong("Vocal Folds Severity Rating:"),
            em("The amount of residue on the vocal folds when PAS is 5."),
            br(),
            strong("Subglottic Severity Rating:"),
            em("The amount of residue below the vocal folds when PAS is 7 or 8."),
            br(),
            strong("Percent Pharyngeal Residue:"),
            em("The percentage of a bolus remaining in the pharynx after initial swallow."),
...
server <- function(input, output) {
    ...
    output$download <- downloadHandler(
        ...
        filename = function() {paste("DIGEST_data.csv",  Sys.Date(), ".csv", sep = "")},
